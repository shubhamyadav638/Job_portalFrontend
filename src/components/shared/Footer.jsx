      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/shubham.yaduvanshi.7393" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://x.com/Shubham08349826" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/shubham-yadav-170b28237/" className="hover:text-gray-400" aria-label="LinkedIn">
